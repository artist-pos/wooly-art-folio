                        ...
                        >
                            <CardContent className="p-0">
                                ...
                                <div className="p-4 md:p-6 space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: poster.caption }} />
                                </div>
                            </CardContent>
                        </Card>
                    ))}
                            ...
                            <Card className="bg-card/80 backdrop-blur-sm border-border">
                                <CardContent className="p-6 md:p-8 space-y-4 text-foreground">
                                    ...
                                    <div className="prose prose-invert prose-lg max-w-none space-y-4">
                                        ...
                                        <p>A colleague was threatened with firing for a back injury. Months later, I wrecked my own back moving tonnes of produce. The manager buried the report.</p>
                                        <p>For years, I was the engine of a liquor department, building the best in Auckland. But I was locked into a 15-hour contract, consistently working 60-hour weeks.</p>
                                        <p>This was not dedication; it was exploitation.</p>
                                        <p>This is the system: the moment my hours approached the material threshold that would necessitate a full-time contract, they were systematically slashed. Mine, and others'. This is a deliberate, widespread strategy to deny workers permanent status and the security that comes with it.</p>
                                        <p>The reward for my loyalty? This January, a slipped disc left me bedridden, unable to carry my child.</p>
                                        <p>When I returned, I was branded "unreliable."</p>
                                        <p>The culture is poisoned by protected misconduct and nepotism.</p>
                                        <p>A senior Union Rep—a man who used racial slurs, bullied and harassed numerous staff (including teenage after-school workers), and engaged in recurring theft for over three years—was not fired. He was protected. The investigations were buried.</p>
                                        <p>This is the standard: cruelty and corruption are tolerated if you're in the right circle.</p>
                                        <p>Meanwhile, a system of cultural nepotism dictates everything.</p>
                                        <p>Jobs are never publicly listed. When hours are freed up, they are reserved for the next family or clique hire. Promotions are whispered, not earned.</p>
                                        <p>I was systematically sidelined from professional development: forbidden from corresponding with merchandisers, blocked from phone calls that were routine for others. This is a deliberate strategy to limit our growth and maintain a controllable in-group.</p>
                                        ...
                                        <p>My 'Woolworst' poster is my testimony—the visual proof of their poison. I have a platform. This is for the hundreds who don't. For everyone who has been told their pain isn't real and their voice doesn't count.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </CollapsibleContent>
